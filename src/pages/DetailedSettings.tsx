...
const DetailedSettings = () => {
  ...
  return (
    <div className="pb-12 pt-4 bg-[#0B1020] text-[#F8FAFC] min-h-screen">
      {/* Top Navigation Bar */}
      <div className="sticky top-0 z-50 bg-[#0B1020]/80 backdrop-blur-md border-b border-white/[0.06] -mt-4 mb-4">
        <div className="flex items-center p-4 justify-between max-w-md mx-auto">
          ...
          <h2 className="text-[#F8FAFC] text-base font-extrabold leading-tight tracking-tight flex-1 text-center pr-10">{t('settings')}</h2>
        </div>
      </div>
      ...
      <div className="px-4 space-y-6">
        {/* Section: General */}
        <section>
          <h3 className="text-[10px] font-black uppercase tracking-widest text-[#94A3B8]/50 px-4 pb-2">{t('general')}</h3>
          <div className="glass-card rounded-2xl overflow-hidden border border-white/[0.04]">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col justify-center">
                  <p className="text-[#F8FAFC] text-xs font-bold leading-normal">{t('language')}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="material-symbols-outlined text-[#94A3B8] text-[18px]">swap_horiz</span>
              </div>
            </div>
            {/* Timezone */}
            <div className="flex items-center gap-4 px-4 min-h-[64px] py-2 justify-between hover:bg-white/5 cursor-pointer transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col justify-center">
                  <p className="text-[#F8FAFC] text-xs font-bold leading-normal">{t('autoDetectTimezone')}</p>
                </div>
              </div>
        ...
        {/* Section: Scanning */}
        <section>
          <h3 className="text-[10px] font-black uppercase tracking-widest text-[#94A3B8]/50 px-4 pb-2">{t('scanning')}</h3>
          <div className="glass-card rounded-2xl overflow-hidden border border-white/[0.04]">
            {/* Auto-scan frequency */}
            <div className="flex items-center gap-4 px-4 min-h-[64px] py-2 justify-between border-b border-white/[0.04] hover:bg-white/5 cursor-pointer">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col justify-center">
                  <p className="text-[#F8FAFC] text-xs font-bold leading-normal">{t('autoScanFrequency')}</p>
                  <p className="text-[#94A3B8]/60 text-[10px] font-semibold mt-0.5">{t('every6Hours')}</p>
                </div>
              </div>
              <span className="material-symbols-outlined text-[#94A3B8]/40 text-[18px]">chevron_right</span>
            </div>
            {/* Request Speed */}
            <div className="flex flex-col gap-2 px-4 py-4 border-b border-white/[0.04]">
              <div className="flex items-center gap-4 justify-between mb-1">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-[#F8FAFC] text-xs font-bold leading-normal">{t('requestSpeed')}</p>
                </div>
              ...
              <div className="flex justify-between text-[9px] text-[#94A3B8]/60 font-bold px-1 mt-1">
                <span>{t('safe')}</span>
            ...
            <div className="flex items-center gap-4 px-4 min-h-[64px] py-2 justify-between hover:bg-white/5">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col justify-center">
                  <p className="text-[#F8FAFC] text-xs font-bold leading-normal">{t('concurrentRequests')}</p>
                  <p className="text-[#94A3B8]/60 text-[10px] font-semibold mt-0.5">{t('simultaneousScans')}</p>
                </div>
              </div>
              <div className="flex items-center bg-white/5 border border-white/[0.08] rounded-full p-0.5">
                <button className="size-7 flex items-center justify-center rounded-full text-[#F8FAFC] hover:bg-white/10 transition-all font-extrabold">-</button>
                <span className="px-3 font-extrabold text-xs text-[#F8FAFC]">3</span>
                <button className="size-7 flex items-center justify-center rounded-full text-[#F8FAFC] hover:bg-white/10 transition-all font-extrabold">+</button>
              </div>
            </div>
          </div>
        ...
        <section>
          <h3 className="text-[10px] font-black uppercase tracking-widest text-[#94A3B8]/50 px-4 pb-2">{t('notifications')}</h3>
          <div className="glass-card rounded-2xl overflow-hidden border border-white/[0.04]">
            <div className="flex items-center gap-4 px-4 min-h-[64px] py-2 justify-between border-b border-white/[0.04]">
              <div className="flex items-center gap-4">
                ...
                <p className="text-[#F8FAFC] text-xs font-bold leading-normal">{t('pushNotifications')}</p>
              </div>
              <Toggle defaultChecked />
            </div>
            <div className="flex items-center gap-4 px-4 min-h-[64px] py-2 justify-between border-b border-white/[0.04]">
              <div className="flex items-center gap-4 pl-13">
                <p className="text-[#F8FAFC] text-xs font-semibold leading-normal">{t('newFollowerAlerts')}</p>
              </div>
              <Toggle defaultChecked />
            </div>
            <div className="flex items-center gap-4 px-4 min-h-[64px] py-2 justify-between">
              <div className="flex items-center gap-4 pl-13">
                <p className="text-[#F8FAFC] text-xs font-semibold leading-normal">{t('lostFollowerAlerts')}</p>
              </div>
              <Toggle defaultChecked />
            </div>
          </div>
        ...
        <div className="text-center pt-4 pb-10">
            <p className="text-[#94A3B8]/40 text-[10px] font-bold">FollowerTrack v1.0.0</p>
            <p className="text-[#94A3B8]/20 text-[9px] mt-1 font-bold">{t('madeWithLove')}</p>
        </div>
      </div>
    </div>
  );
